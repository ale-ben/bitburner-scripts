...
export function logServerDetails(ns, server) {
    ...
    printString += `hack____: ${ns.tFormat(hackTime)} (t=${curMoneyHackingThreadsAmount}),\nSec increase: ${ns.hackAnalyzeSecurity(curMoneyHackingThreadsAmount, server)}\n\n`;
